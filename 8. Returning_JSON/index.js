 ...
 const SERVER = HTTP.createServer((req, res)=>{
    ...
    req.on('end', ()=>{
        ...
        choosenHandler(data, (statusCode, payload)=>{
            ...
            // setting content-type as json and returing the response
 ...
 /* Output:
    node index.js     
        ...
        localhost:3000/sample
            server is listening at port: 3000
            Returing the response 406 {
            "trimmedPath": "sample",
            "queryStringObject": {},
            "method": "post",
            "headers": {
                "cache-control": "no-cache",
                "postman-token": "679b97d0-7c1c-459e-af93-b6ab3e308123",
